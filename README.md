...
Ветка содержить базовую серверную логику проекта Melody: настройка Express/Node.js, маршрутизация, CRUD-операции для основных сущностей, обработка ошибок и middleware.

## Запуск
```bash
git checkout feature/PROJ-005-server-crud
